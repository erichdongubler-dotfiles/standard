...
2. `full`: All of Erich's preferred workflow, and only job-specific tooling may
	need to be added after this point. The remainder of this document describes
...
| 1: Installs `git`                                                                              | ✔         | ✔      |
| 2: Installs `openssh`                                                                          | ✔         | ✔      |
| 3: Configures `git` with a GPG key                                                             | ❌        | ✔      |
| 4: Auto-installs [Erich's preferred binaries and applications][preferred-bins]                 | ❌        | ✔      |
| 5: Installs and configures a [shell with Erichs' preferred features][preferred-shell-features] | ❌        | ✔      |
| 6: Enables focus-follows-mouse                                                                 | ❌        | ✔      |
| 7: Enables alt-dragging                                                                        | ❌        | ✔      |
