...
| 4: Installs and configures a [shell with Erich's preferred features][preferred-shell-features] | ❌        | ✔      |
...
1. [`neovim`](https://github.com/neovim/neovim), in tandem with the [`neovim` dotfiles
